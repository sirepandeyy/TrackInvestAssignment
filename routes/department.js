...
var Department = /** @class */ (function () {
    function Department(database) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        id = req.params.id;
                        query = 'select * from department where d_id=$1';
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        key = req.params.key;
                        if (!(key == 'd_name' || key == 'd_id')) return [3 /*break*/, 2];
                        query = 'select * from department ORDER BY ' + req.params.key;
        ...
        this.router.post('/', function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var data, query, result, err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        data = req.body;
                        query = 'INSERT INTO department(d_name) VALUES($1)';
                        return [4 /*yield*/, db.query(query, [data.d_name])];
                    case 1:
                        result = _a.sent();
        ...
        this.router.put('/:id', function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var data, query, result, err_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        data = req.body;
                        query = 'UPDATE department SET d_name=$1 WHERE d_id=$2';
                        return [4 /*yield*/, db.query(query, [data.d_name, req.params.id])];
                    case 1:
                        result = _a.sent();
        ...
        this.router.delete('/:id', function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var query, result, err_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        query = 'UPDATE department SET active=$1 WHERE d_id=$2';
    ...
    Department.prototype.route = function () {
        return this.router;
    };
    return Department;
}());
